...
Js.Center.Business.ProductUpdate.func = function(){
            ...
            handler: function(){
                ...
                for (var i = 0; i < tostorelength; i++) {
                	...
                	if(record.get("vc2subcode") != ""){
        				...
        				record.set("vc2svcname",record.get("vc2svcname1")+"_"+record.get("vc2subcode")  + "   <img src='jspack/product/common/Images/file-add.gif' qtip='添加/修改扩展子号码' onclick='Js.Center.Business.ProductUpdate.addSubCode(\""+record.get("numsvcid1")+"\",\""+record.get("vc2subcode")+"\")'/>" + "<img src='jspack/product/common/Images/file-remove.gif' qtip='删除扩展子号码' onclick='Js.Center.Business.ProductUpdate.deleteSubCode(\""+record.get("numsvcid1")+"\")'/>");
        				record.commit();
                	}
                };
                record = tostroedata.getById(Ext.getCmp("Js.Center.Business.ProductUpdate.SubcodeSvcid").getValue());
                record.set("vc2subcode",subCode);
                record.set("numsvcid",record.get("numsvcid1")+"_"+record.get("vc2subcode"));
				record.set("vc2svcname",record.get("vc2svcname1")+"_"+record.get("vc2subcode")  + "   <img src='jspack/product/common/Images/file-add.gif' qtip='添加/修改扩展子号码' onclick='Js.Center.Business.ProductUpdate.addSubCode(\""+record.get("numsvcid1")+"\",\""+record.get("vc2subcode")+"\")'/>" + "<img src='jspack/product/common/Images/file-remove.gif' qtip='删除扩展子号码' onclick='Js.Center.Business.ProductUpdate.deleteSubCode(\""+record.get("numsvcid1")+"\")'/>");
				record.commit();
    ...
    Js.Center.Business.ProductUpdate.deleteSubCode = function(svcid){
    	...
    	record.set("numsvcid",record.get("numsvcid1"));
     	...
     	var emp = record.get("vc2svcname1")+"_" + "   <img src='jspack/product/common/Images/file-add.gif' qtip='添加/修改扩展子号码' onclick='Js.Center.Business.ProductUpdate.addSubCode(\""+record.get("numsvcid1")+"\",\""+record.get("vc2subcode")+"\")'/>" + "<img src='jspack/product/common/Images/file-remove.gif' qtip='删除扩展子号码' onclick='Js.Center.Business.ProductUpdate.deleteSubCode(\""+record.get("numsvcid1")+"\")'/>";
    	record.set("vc2svcname",emp);
    	record.commit();
    ...
    //if (Js.Center.Business.ProductUpdate.AddproductInfoWin == null) {
	//==============================================================为产品已指定的通道下拉列表数据定义
    ...
    Js.Center.Business.ProductUpdate.ReloadServiceCodeStore =  function(){
    	...
    	productPermitsvcStore.baseParams = {
            flag: 'selectecservice',
            numprodid: Js.Center.Business.ProductUpdate.window.updateRecord.get("numprodid"),//Js.Center.Business.ProductUpdate.window.updateRecord.get("numprodid"),
...
//        bodyStyle: "padding:10px 0 10px 15px",
    ...
    //}
    //Js.Center.Business.ProductUpdate.AddproductInfoWin.mainForm.reset();
    // ======================================================================== 执行显示    
   // Js.Center.Business.ProductUpdate.AddproductInfoWin.show();
